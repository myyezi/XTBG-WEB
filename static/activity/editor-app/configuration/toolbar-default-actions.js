...
var SaveModelCtrl = [ '$rootScope', '$scope', '$http', '$route', '$location',
    ...
    $scope.save = function (successCallback) {
        ...
        // var condionObjArr = angular.fromJson(sessionStorage.getItem('condionObjArr'))
        // $http({
        //     method: 'post',
        //     headers: {'Accept': 'application/json','Content-Type': 'application/json; charset=UTF-8'},
        //     url: 'https://dev.zdsxc.com/activiti/act/saveCondition',
        //     data:{condition:condionObjArr,modelId:modelId}
