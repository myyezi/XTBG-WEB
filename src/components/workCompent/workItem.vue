            ...
            <div class="node-wrap-box node_sid-startevent" :class="{'start-node':workData.nodeType==1}">
                <div>
                    ...
                    <div class="content" @click="settingCount(workData)">
                        <div class="text" v-if="workData.nodeType==1">{{workData.nodeText?workData.nodeText:'请选择发起人'}}</div>
                        <div class="text" v-if="workData.nodeType==2">{{workData.nodeText?workData.nodeText:'请选择审批人'}}</div>
                        <div class="text" v-if="workData.nodeType==3">{{workData.nodeText?workData.nodeText:'请选择抄送人'}}</div>
                        ...
                        <div class="condition-node">
                            <div class="condition-node-box">
                                <div class="auto-judge">
                                    ...
                                    <div class="content" @click="settingCount(item)">
                                        <div class="text">{{item.nodeText?item.nodeText:'请设置条件'}}</div>
                                        <i class="anticon el-icon-arrow-right"></i>
                                    </div>
                                </div>
                                <div class="add-node-btn">
