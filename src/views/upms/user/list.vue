    ...
    <div class="app-container white-bg list-panel" v-cloak>
        ...
        <div class="table-box">
            <el-table :data="list" style="width: 100%">
                <el-table-column prop="name" fixed sortable show-overflow-tooltip min-width="100" label="姓名"></el-table-column>
                <el-table-column prop="account" sortable min-width="120" label="手机号"></el-table-column>
                <el-table-column prop="gender" sortable show-overflow-tooltip min-width="80" label="性别"></el-table-column>
                <el-table-column prop="birthday" sortable show-overflow-tooltip min-width="100" label="生日"></el-table-column>
                <el-table-column prop="education" sortable show-overflow-tooltip min-width="100" label="学历"></el-table-column>
                <el-table-column prop="qualification" sortable show-overflow-tooltip min-width="100" label="职称"></el-table-column>
                <el-table-column prop="companys" sortable show-overflow-tooltip min-width="150" label="所属管理公司"></el-table-column>
