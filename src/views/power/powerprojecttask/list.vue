<template>
  <div class="app-container white-bg list-panel" v-cloak>
    <div class="opertion-box">
      <el-button style="background-color: #29c9bb;border-color: #29c9bb;color: #FFF;margin-right:10px" icon="el-icon-plus" size="small" @click="add()" >创建
      </el-button>
      <el-input v-model="searchParam.codeOrName" placeholder="请输入项目名称或编号" clearable class="zy_input" style="width:190px"></el-input>
      <el-button style="background-color: #29c9bb;border-color: #29c9bb;color: #FFF" icon="el-icon-search" size="small" @click="handleCurrentChange(1);resetCardList()">查询</el-button>
      ...
      <el-button style="background-color: #29c9bb;border-color: #29c9bb;color: #FFF" icon="el-icon-refresh" size="small" @click="resetList();resetCardList()">重置</el-button>
      <el-button style="background-color: #29c9bb;border-color: #29c9bb;color: #FFF" icon="el-icon-s-operation" size="small" @click="swtichData()">切换</el-button>
    </div>
    <!-- 展开更多查询开始 -->
      ...
      <div class="search-box" v-show="isShowMore">
        <div class="form-box">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <el-date-picker v-model="searchParam.year" type="year" value-format="yyyy" placeholder="请选择项目年份">
              </el-date-picker>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <el-select v-model="searchParam.belongCompany" filterable clearable placeholder="请选择归属单位">
                <el-option v-for="item in belongCompanyList" :key="item.value" :label="item.text" :value="item.value">
                </el-option>
              </el-select>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <el-date-picker v-model="createTime" type="daterange" :editable="false" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd HH:mm:ss ">
              </el-date-picker>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="input-group">
              <el-date-picker v-model="signTime" type="daterange" :editable="false" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd HH:mm:ss ">
              </el-date-picker>
            </div>
          </div>
