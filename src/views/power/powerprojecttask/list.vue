<template>
    <div class="app-container white-bg list-panel" v-cloak>
        <div class="opertion-box">
            <el-button style="background-color: #29c9bb;border-color: #29c9bb;color: #FFF;margin-right:10px"
                       icon="el-icon-plus" size="small" @click="add()">创建
            </el-button>
            <el-input v-model="searchParam.codeOrName" placeholder="请输入项目名称或编号" clearable class="zy_input"
                      style="width:190px"></el-input>
            <el-button style="background-color: #29c9bb;border-color: #29c9bb;color: #FFF" icon="el-icon-search"
                       size="small" @click="handleCurrentChange(1);resetCardList()">查询
            </el-button>
            <el-button style="background-color: #29c9bb;border-color: #29c9bb;color: #FFF" icon="el-icon-menu"
                       size="small" @click="isShowMore = !isShowMore">更多查询<i
                :class="[isShowMore ? 'el-icon-caret-bottom' : 'el-icon-caret-top', 'el-icon--right'] "></i></el-button>
            <el-button style="background-color: #29c9bb;border-color: #29c9bb;color: #FFF" icon="el-icon-refresh"
                       size="small" @click="resetList();resetCardList()">重置
            </el-button>
            <el-button style="background-color: #29c9bb;border-color: #29c9bb;color: #FFF" icon="el-icon-s-operation"
                       size="small" @click="swtichData()">切换
            </el-button>
        </div>
        <!-- 展开更多查询开始 -->
            ...
            <div class="search-box" v-show="isShowMore">
                <div class="form-box">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <el-select v-model="searchParam.type" clearable placeholder="请选择项目类型"
                                       @change="chickProjectType(searchParam.type)">
                                <el-option v-for="item in typeOptions" :key="item.value" :label="item.text"
                                           :value="item.value">
                                </el-option>
                            </el-select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <el-date-picker v-model="searchParam.year" type="year" value-format="yyyy"
                                            placeholder="请选择项目年份">
                            </el-date-picker>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <city-select-panel :value.sync="citySelectArr" ref="citySelect"
                                               @change="citySelectOnchange"></city-select-panel>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <el-select v-model="searchParam.source" placeholder="请选择任务依据">
                                <el-option v-for="item in sourceOptions" :key="item.value" :label="item.text"
                                           :value="item.value">
                                </el-option>
                            </el-select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <el-select v-model="searchParam.coDepartment" multiple filterable default-first-option
                                       placeholder="请选择协办部门">
                                <el-option v-for="item in coDepartmentOptions" :key="item.value" :label="item.text"
                                           :value="item.value">
                                </el-option>
                            </el-select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <el-select v-model="searchParam.relatedDesign" multiple filterable default-first-option
                                       placeholder="请选择相关设计">
                                <el-option v-for="item in designOptions" :key="item.value" :label="item.text"
                                           :value="item.value">
                                </el-option>
                            </el-select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <el-date-picker v-model="createTime" type="daterange" :editable="false" range-separator="至"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <el-date-picker v-model="signTime" type="daterange" :editable="false" range-separator="至"
                                            start-placeholder="开始日期" end-placeholder="结束日期"
                                            value-format="yyyy-MM-dd HH:mm:ss ">
                            </el-date-picker>
                        </div>
            ...
            <el-table :data="list" style="width: 100%">
                <el-table-column fixed label="操作" min-width="100">
                    <template fixed slot-scope="{ row, column, $index }">
                        ...
                        <el-button v-show="showDownloadBtn" @click="downloadZip(row.id)" type="text" size="small">打包下载
                        </el-button>
                ...
                <el-table-column prop="name" sortable show-overflow-tooltip min-width="180"
                                 label="项目名称"></el-table-column>
                <el-table-column prop="typeText" sortable show-overflow-tooltip min-width="80"
                                 label="项目类型"></el-table-column>
                <el-table-column prop="year" sortable show-overflow-tooltip min-width="60"
                                 label="项目年份"></el-table-column>
                <el-table-column prop="manager" sortable show-overflow-tooltip min-width="80"
                                 label="项目经理"></el-table-column>
                <el-table-column prop="createTime" sortable show-overflow-tooltip min-width="120"
                                 label="下达时间"></el-table-column>
            </el-table>
            <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="page"
                           :page-sizes="pageSizeSetting" :page-size="pageSize" :layout="pageLayout" :total="listCount">
            </el-pagination>
        </div>
        <div class="table-box" v-show="tableShow">
                    ...
                    <el-card class="box-card" shadow="hover">
                        ...
                        <div>
                            ...
                            <div style="text-align: right;">
                                <el-button size="small" v-show="showEditBtn" round @click="edit(item.id)">编辑</el-button>
                                <el-button size="small" v-show="showDownloadBtn" round @click="downloadZip(item.id)">
                                    打包下载
                                </el-button>
                                <el-button size="small" v-show="showEditBtn" round @click="showDig(item.id)">记录
                                </el-button>
                            </div>
                        </div>
                    </el-card>
            ...
            <div class="app-container white-bg list-panel">
                ...
                <div class="table-box">
                    <el-table :data="detailList" style="width: 100%">
                        <el-table-column prop="name" sortable show-overflow-tooltip min-width="80"
                                         label="修改字段名"></el-table-column>
                        <el-table-column prop="beforeValue" sortable show-overflow-tooltip min-width="80"
                                         label="修改前值"></el-table-column>
                        <el-table-column prop="afterValue" sortable show-overflow-tooltip min-width="80"
                                         label="修改后值"></el-table-column>
                        <el-table-column prop="updater" sortable show-overflow-tooltip min-width="80"
                                         label="修改人"></el-table-column>
                        <el-table-column prop="updateTime" sortable show-overflow-tooltip min-width="80"
                                         label="修改时间"></el-table-column>
                    </el-table>
                    <el-pagination @size-change="handleSizeChange2" @current-change="handleCurrentChange2"
                                   :current-page=pageList.current :page-size=pageList.size :total=pageList.total>
                    </el-pagination>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getChangeList() {
                ajax.get('power/powerprojecttaskchange', {
