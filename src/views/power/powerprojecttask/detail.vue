            ...
            <el-tabs v-model="activeName" @tab-click="handleClick">
                ...
                <el-tab-pane label="项目成员" name="projectMemberInfoTab">
                    <el-table border :data="memberList" style="width: 100%">
                        <el-table-column prop="name" sortable show-overflow-tooltip min-width="100"
                                         label="成员名称"></el-table-column>
                        <el-table-column prop="account" sortable show-overflow-tooltip min-width="100"
                                         label="手机号"></el-table-column>
                        <el-table-column prop="profession" sortable show-overflow-tooltip min-width="300"
    ...
    export default {
        ...
        methods: {
            handleClick(tab, event) {
                ...
                } else if (tab.name == 'projectNsInfoTab') {
                    this.getProjectAttachmentList(3)
                }
                else if (tab.name == 'projectScInfoTab') {
