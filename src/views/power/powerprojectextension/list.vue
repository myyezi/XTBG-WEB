    ...
    <el-collapse-transition>
      <div class="search-box" v-show="isShowMore">
        <div class="form-box">
          ...
          <div class="form-group">
            <label class="control-label">延期日期</label>
            <div class="input-group">
              <el-input v-model="searchParam.extDate" placeholder="请输入延期日期"></el-input>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label">延期原因</label>
            <div class="input-group">
              <el-input v-model="searchParam.reason" placeholder="请输入延期原因"></el-input>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <el-input v-model="searchParam.approvalReason" placeholder="请输入审批原因"></el-input>
            </div>
          </div>
          <div class="form-group">
...
export default {
  ...
  data() {
    return {
      isShowMore: false,
      listUrl: "project/powerprojectextension",
      showSearch: false,
      showAddBtn: this.getCurrentUserAuthority("/powerprojectextension/save"),
      showEditBtn: this.getCurrentUserAuthority("/powerprojectextension/edit")
    }
  },
  mounted() {
    this.getList();
