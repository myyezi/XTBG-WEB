        ...
        <el-collapse-transition>
            <div class="search-box" v-show="isShowMore">              
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.name" placeholder="请输入物品名称"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">物品类型（1-资产，2-耗材）</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.type" placeholder="请输入物品类型（1-资产，2-耗材）"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="name" sortable show-overflow-tooltip min-width="100" label="物品名称"></el-table-column>
                                <el-table-column prop="type" sortable show-overflow-tooltip min-width="100" label="物品类型（1-资产，2-耗材）"></el-table-column>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                isShowMore:false,
                listUrl: "adm/admgoodsdict",
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/admgoodsdict/save"),
                showEditBtn: this.getCurrentUserAuthority("/admgoodsdict/edit")
            }
        },
        mounted() {
            this.getList();
