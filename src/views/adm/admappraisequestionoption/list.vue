        ...
        <el-collapse-transition>
            <div class="search-box" v-show="isShowMore">              
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.text" placeholder="请输入选项内容"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.value" placeholder="请输入选项值"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">选项图片（图片地址）</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.picture" placeholder="请输入选项图片（图片地址）"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.updateTime" placeholder="请输入修改时间"></el-input>
                                       ...
                                       <div class="form-group">
                        <label class="control-label">考核题目ID</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.appraiseQuestionId" placeholder="请输入考核题目ID"></el-input>
                        </div>
                    </div>
                                   </div>
            </div>
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="text" sortable show-overflow-tooltip min-width="100" label="选项内容"></el-table-column>
                                ...
                                <el-table-column prop="value" sortable show-overflow-tooltip min-width="100" label="选项值"></el-table-column>
                                <el-table-column prop="picture" sortable show-overflow-tooltip min-width="100" label="选项图片（图片地址）"></el-table-column>
                                ...
                                <el-table-column prop="appraiseQuestionId" sortable show-overflow-tooltip min-width="100" label="考核题目ID"></el-table-column>
                            </el-table>
            <el-pagination
...
<script>
    ...
    export default {
        name: 'AdmAppraiseQuestionOption',
        mixins: [tool],
        data() {
            return {
                isShowMore:false,
                listUrl: "adm/admappraisequestionoption",
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/admappraisequestionoption/save"),
                showEditBtn: this.getCurrentUserAuthority("/admappraisequestionoption/edit")
            }
        },
        mounted() {
            this.getList();
