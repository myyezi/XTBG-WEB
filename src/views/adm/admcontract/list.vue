        ...
        <el-collapse-transition>
            <div class="search-box" v-show="isShowMore">              
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.name" placeholder="请输入合同名称"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.amount" placeholder="请输入金额"></el-input>
                                       ...
                                       <div class="form-group">
                        <label class="control-label">签订人(用户id)</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.signer" placeholder="请输入签订人(用户id)"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">签订时间</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.signTime" placeholder="请输入签订时间"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">收款进度</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.progress" placeholder="请输入收款进度"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="signer" sortable show-overflow-tooltip min-width="100" label="签订人(用户id)"></el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/admcontract/save"),
