        ...
        <el-collapse-transition>
            <div class="search-box" v-show="isShowMore">              
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.courseId" placeholder="请输入课程ID"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="courseId" sortable show-overflow-tooltip min-width="100" label="课程ID"></el-table-column>
...
<script>
    ...
    export default {
        name: 'AdmCourseEmployee',
        mixins: [tool],
        data() {
            return {
                isShowMore:false,
                listUrl: "adm/admcourseemployee",
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/admcourseemployee/save"),
                showEditBtn: this.getCurrentUserAuthority("/admcourseemployee/edit")
            }
        },
        mounted() {
            this.getList();
