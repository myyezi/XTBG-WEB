        ...
        <el-collapse-transition>
            <div class="search-box" v-show="isShowMore">              
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.content" placeholder="请输入内容"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="content" sortable show-overflow-tooltip min-width="100" label="内容"></el-table-column>
                                <el-table-column prop="publishTime" sortable show-overflow-tooltip min-width="100" label="发布时间"></el-table-column>
                                <el-table-column prop="readCount" sortable show-overflow-tooltip min-width="100" label="阅读量"></el-table-column>
                                <el-table-column prop="courseStatus" sortable show-overflow-tooltip min-width="100" label="课程状态(1-未发布 2-已发布)"></el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/admcourse/save"),
                showEditBtn: this.getCurrentUserAuthority("/admcourse/edit")
            }
        },
        mounted() {
            this.getList();
