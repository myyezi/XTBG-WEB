                ...
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.appraiseId" placeholder="请输入考核表ID"></el-input>
                                       ...
                                       <div class="form-group">
                        <label class="control-label">考核题目</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.appraiseQuestionId" placeholder="请输入考核题目"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">答案</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.answer" placeholder="请输入答案"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="appraiseQuestionId" sortable show-overflow-tooltip min-width="100" label="考核题目"></el-table-column>
                                <el-table-column prop="answer" sortable show-overflow-tooltip min-width="100" label="答案"></el-table-column>
...
<script>
    ...
    export default {
        name: 'AdmAppraiseEmployeeAnswer',
        mixins: [tool],
        data() {
            return {
                isShowMore:false,
                listUrl: "adm/admappraiseemployeeanswer",
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/admappraiseemployeeanswer/save"),
                showEditBtn: this.getCurrentUserAuthority("/admappraiseemployeeanswer/edit")
            }
        },
        mounted() {
            this.getList();
