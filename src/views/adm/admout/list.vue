        ...
        <el-collapse-transition>
            <div class="search-box" v-show="isShowMore">              
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.address" placeholder="请输入地址"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.endTime" placeholder="请输入结束时间"></el-input>
                                       ...
                                       <div class="form-group">
                        <label class="control-label">外出时长（天）</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.outTime" placeholder="请输入外出时长（天）"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="address" sortable show-overflow-tooltip min-width="100" label="地址"></el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                listUrl: "adm/admout",
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/admout/save"),
                showEditBtn: this.getCurrentUserAuthority("/admout/edit")
            }
        },
        mounted() {
            this.getList();
