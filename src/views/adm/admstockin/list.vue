        ...
        <el-collapse-transition>
            <div class="search-box" v-show="isShowMore">              
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.purchaseId" placeholder="请输入采购单ID"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">入库数量</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.stockInNum" placeholder="请输入入库数量"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="purchaseId" sortable show-overflow-tooltip min-width="100" label="采购单ID"></el-table-column>
                                <el-table-column prop="stockInNum" sortable show-overflow-tooltip min-width="100" label="入库数量"></el-table-column>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                isShowMore:false,
                listUrl: "adm/admstockin",
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/admstockin/save"),
                showEditBtn: this.getCurrentUserAuthority("/admstockin/edit")
            }
        },
        mounted() {
            this.getList();
