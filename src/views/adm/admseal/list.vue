                ...
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.companyId" placeholder="请输入所属管理公司(组织表管理公司id)"></el-input>
                                       ...
                                       <div class="form-group">
                        <label class="control-label">交付单位</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.delivery" placeholder="请输入交付单位"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">用印事由</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.reason" placeholder="请输入用印事由"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="delivery" sortable show-overflow-tooltip min-width="100" label="交付单位"></el-table-column>
                                <el-table-column prop="reason" sortable show-overflow-tooltip min-width="100" label="用印事由"></el-table-column>
