        ...
        <el-collapse-transition>
            <div class="search-box" v-show="isShowMore">              
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.address" placeholder="请输入目的地"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.endTime" placeholder="请输入结束时间"></el-input>
                                       ...
                                       <div class="form-group">
                        <label class="control-label">车型(关联字典表)</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.car" placeholder="请输入车型(关联字典表)"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="car" sortable show-overflow-tooltip min-width="100" label="车型(关联字典表)"></el-table-column>
