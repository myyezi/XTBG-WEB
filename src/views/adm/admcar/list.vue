<template>
    <div class="app-container white-bg list-panel" v-cloak>
        <div class="opertion-box">
            ...
            <el-input v-model="searchParam.creater" placeholder="请输入员工姓名或手机号" clearable class="zy_input" style="width:190px"></el-input>
            ...
            <div class="search-box" v-show="isShowMore">              
                <div class="form-box">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.car" placeholder="请选择车型"></el-input>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">审批状态</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.approvalStatus" placeholder="请选择审批状态"></el-input>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <el-table :data="list" style="width: 100%">
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">还车</el-button>
                    </template>
                </el-table-column>
                ...
                <el-table-column prop="approvalStatus" sortable show-overflow-tooltip min-width="100" label="还车状态"></el-table-column>
                <el-table-column prop="status" sortable show-overflow-tooltip min-width="100" label="申请状态"></el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                listUrl: "adm/admcar",
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/admcar/save"),
                showEditBtn: this.getCurrentUserAuthority("/admcar/edit"),
                createTime: [],
            }
        },
        mounted() {
