        ...
        <el-collapse-transition>
            <div class="search-box" v-show="isShowMore">              
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.supplierId" placeholder="请输入供应商id"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.company" placeholder="请输入单位"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="supplierId" sortable show-overflow-tooltip min-width="100" label="供应商id"></el-table-column>
                                ...
                                <el-table-column prop="company" sortable show-overflow-tooltip min-width="100" label="单位"></el-table-column>
...
<script>
    ...
    export default {
        name: 'AdmSupplierContact',
        mixins: [tool],
        data() {
            return {
                isShowMore:false,
                listUrl: "adm/admsuppliercontact",
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/admsuppliercontact/save"),
                showEditBtn: this.getCurrentUserAuthority("/admsuppliercontact/edit")
            }
        },
        mounted() {
            this.getList();
