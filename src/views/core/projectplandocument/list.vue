                ...
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.planId" placeholder="请输入项目计划id"></el-input>
                                       ...
                                       <div class="form-group">
                        <label class="control-label">类目编号</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.code" placeholder="请输入类目编号"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">类目名称</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.name" placeholder="请输入类目名称"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">需归档文件内容</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.content" placeholder="请输入需归档文件内容"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">立卷单位</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.filingCompany" placeholder="请输入立卷单位"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="code" sortable show-overflow-tooltip min-width="100" label="类目编号"></el-table-column>
                                <el-table-column prop="name" sortable show-overflow-tooltip min-width="100" label="类目名称"></el-table-column>
                                <el-table-column prop="content" sortable show-overflow-tooltip min-width="100" label="需归档文件内容"></el-table-column>
                                <el-table-column prop="filingCompany" sortable show-overflow-tooltip min-width="100" label="立卷单位"></el-table-column>
...
<script>
    ...
    export default {
        name: 'CoreProjectPlanDocument',
        mixins: [tool],
        data() {
            return {
                isShowMore:false,
                listUrl: "core/projectplandocument",
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/projectplandocument/save"),
                showEditBtn: this.getCurrentUserAuthority("/projectplandocument/edit")
            }
        },
        mounted() {
            this.getList();
