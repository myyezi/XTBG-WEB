                ...
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.name" placeholder="请输入名称"></el-input>
                                       ...
                                       <div class="form-group">
                        <label class="control-label">类型（1-输电线路工程，2-变电站工程）</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.type" placeholder="请输入类型（1-输电线路工程，2-变电站工程）"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">计划开始日期</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.startDate" placeholder="请输入计划开始日期"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">计划结束日期</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.endDate" placeholder="请输入计划结束日期"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="type" sortable show-overflow-tooltip min-width="100" label="类型（1-输电线路工程，2-变电站工程）"></el-table-column>
                                <el-table-column prop="startDate" sortable show-overflow-tooltip min-width="100" label="计划开始日期"></el-table-column>
                                <el-table-column prop="endDate" sortable show-overflow-tooltip min-width="100" label="计划结束日期"></el-table-column>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                isShowMore:false,
                listUrl: "core/projectsub",
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/projectsub/save"),
                showEditBtn: this.getCurrentUserAuthority("/projectsub/edit")
            }
        },
        mounted() {
            this.getList();
