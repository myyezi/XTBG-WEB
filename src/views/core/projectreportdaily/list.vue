            ...
            <el-table :data="list" style="width: 100%">
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">填写日报</el-button>
                    </template>
                </el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                showSearch: false,
                showEditBtn: this.getCurrentUserAuthority("/projectreportdaily/add"),
                showEditBtn: this.getCurrentUserAuthority("/projectreportdaily/edit")
            }
        },
        mounted() {
            this.getList();
