                ...
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.id" placeholder="请输入主键id"></el-input>
                                       ...
                                       <div class="form-group">
                        <label class="control-label">模板设置id</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.templateConfigId" placeholder="请输入模板设置id"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">项目文档模板id</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.projectArchiveTemplateId" placeholder="请输入项目文档模板id"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="templateConfigId" sortable show-overflow-tooltip min-width="100" label="模板设置id"></el-table-column>
                                <el-table-column prop="projectArchiveTemplateId" sortable show-overflow-tooltip min-width="100" label="项目文档模板id"></el-table-column>
...
<script>
    ...
    export default {
        name: 'CoreProjectArchiveTemplate',
        mixins: [tool],
        data() {
            return {
                isShowMore:false,
                listUrl: "core/projectarchivetemplate",
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/projectarchivetemplate/save"),
                showEditBtn: this.getCurrentUserAuthority("/projectarchivetemplate/edit")
            }
        },
        mounted() {
            this.getList();
