                ...
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.templateConfigId" placeholder="请输入模板设置id"></el-input>
                                       ...
                                       <div class="form-group">
                        <label class="control-label">安全风险库id</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.safeRiskId" placeholder="请输入安全风险库id"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="safeRiskId" sortable show-overflow-tooltip min-width="100" label="安全风险库id"></el-table-column>
...
<script>
    ...
    export default {
        name: 'CoreProjectRiskTemplate',
        mixins: [tool],
        data() {
            return {
                isShowMore:false,
                listUrl: "core/projectrisktemplate",
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/projectrisktemplate/save"),
                showEditBtn: this.getCurrentUserAuthority("/projectrisktemplate/edit")
            }
        },
        mounted() {
            this.getList();
