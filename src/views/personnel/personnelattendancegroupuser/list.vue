  ...
  <div class="app-container white-bg list-panel" v-cloak>
      ...
      <div class="search-box" v-show="isShowMore">
        <div class="form-box">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <el-input v-model="searchParam.userId" placeholder="请输入用户"></el-input>
            </div>
          </div>
          <div class="form-group">
    ...
    <div class="table-box">
      <el-table :data="list" style="width: 100%">
        ...
        <el-table-column prop="userId" sortable show-overflow-tooltip min-width="100" label="用户"></el-table-column>
...
export default {
  ...
  data() {
    return {
      isShowMore: false,
      listUrl: "personnel/personnelattendancegroupuser",
      showSearch: false,
      showAddBtn: this.getCurrentUserAuthority("/personnelattendancegroupuser/save"),
      showEditBtn: this.getCurrentUserAuthority("/personnelattendancegroupuser/edit")
    }
  },
  mounted() {
    this.getList();
