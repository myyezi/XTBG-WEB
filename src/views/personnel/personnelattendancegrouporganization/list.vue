  ...
  <div class="app-container white-bg list-panel" v-cloak>
    ...
    <el-collapse-transition>
      <div class="search-box" v-show="isShowMore">
        <div class="form-box">
          ...
          <div class="form-group">
            <label class="control-label">考勤组</label>
            <div class="input-group">
              <el-input v-model="searchParam.attendanceGroupId" placeholder="请输入考勤组"></el-input>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label">部门</label>
            <div class="input-group">
              <el-input v-model="searchParam.organizationId" placeholder="请输入部门"></el-input>
            </div>
          </div>
          <div class="form-group">
    ...
    <div class="table-box">
      <el-table :data="list" style="width: 100%">
        ...
        <el-table-column prop="attendanceGroupId" sortable show-overflow-tooltip min-width="100" label="考勤组"></el-table-column>
        <el-table-column prop="organizationId" sortable show-overflow-tooltip min-width="100" label="部门"></el-table-column>
...
export default {
  ...
  data() {
    return {
      isShowMore: false,
      listUrl: "personnel/personnelattendancegrouporganization",
      showSearch: false,
      showAddBtn: this.getCurrentUserAuthority("/personnelattendancegrouporganization/save"),
      showEditBtn: this.getCurrentUserAuthority("/personnelattendancegrouporganization/edit")
    }
  },
  mounted() {
    this.getList();
