...
<script>
    ...
    export default {
        ...
        data() {
            return {
                isShowMore:false,
                listUrl: "finance/financereimburse",
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/financereimburse/save"),
                showEditBtn: this.getCurrentUserAuthority("/financereimburse/edit")
            }
        },
        mounted() {
            this.getList();
