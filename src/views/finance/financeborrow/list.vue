                ...
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.amount" placeholder="请输入金额"></el-input>
                                       ...
                                       <div class="form-group">
                        <label class="control-label">借支事由</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.reason" placeholder="请输入借支事由"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="reason" sortable show-overflow-tooltip min-width="100" label="借支事由"></el-table-column>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                isShowMore:false,
                listUrl: "finance/financeborrow",
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/financeborrow/save"),
                showEditBtn: this.getCurrentUserAuthority("/financeborrow/edit")
            }
        },
        mounted() {
            this.getList();
