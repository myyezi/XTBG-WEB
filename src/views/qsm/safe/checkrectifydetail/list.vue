                ...
                <div class="form-box">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.id" placeholder="请输入主键id"></el-input>
                                       ...
                                       <div class="form-group">
                        <label class="control-label">整改单id</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.checkRectifyId" placeholder="请输入整改单id"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">问题单明细id</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.checkDetailId" placeholder="请输入问题单明细id"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        ...
                        <div class="input-group">
                            <el-input v-model="searchParam.rectifyDate" placeholder="请输入整改日期"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">整改情况</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.rectifySituation" placeholder="请输入整改情况"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">整改单位</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.rectifyCompany" placeholder="请输入整改单位"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">整改负责人</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.rectifyPerson" placeholder="请输入整改负责人"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                        <label class="control-label">整改时间</label>
                        <div class="input-group">
                            <el-input v-model="searchParam.rectifyTime" placeholder="请输入整改时间"></el-input>
                        </div>
                    </div>
                                       <div class="form-group">
                ...
                <el-table-column fixed label="操作" width="120">
                    <template fixed slot-scope="{ row, column, $index }">
                        <el-button v-show="showEditBtn" @click="edit(row.id)" type="text" size="small">编辑</el-button>
                                ...
                                <el-table-column prop="checkRectifyId" sortable show-overflow-tooltip min-width="100" label="整改单id"></el-table-column>
                                <el-table-column prop="checkDetailId" sortable show-overflow-tooltip min-width="100" label="问题单明细id"></el-table-column>
                                ...
                                <el-table-column prop="rectifyDate" sortable show-overflow-tooltip min-width="100" label="整改日期"></el-table-column>
                                <el-table-column prop="rectifySituation" sortable show-overflow-tooltip min-width="100" label="整改情况"></el-table-column>
                                <el-table-column prop="rectifyCompany" sortable show-overflow-tooltip min-width="100" label="整改单位"></el-table-column>
                                <el-table-column prop="rectifyPerson" sortable show-overflow-tooltip min-width="100" label="整改负责人"></el-table-column>
                                <el-table-column prop="rectifyTime" sortable show-overflow-tooltip min-width="100" label="整改时间"></el-table-column>
...
<script>
    ...
    export default {
        name: 'SafeCheckRectifyDetail',
        mixins: [tool],
        data() {
            return {
                isShowMore:false,
                listUrl: "qsm/checkrectifydetail",
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/checkrectifydetail/save"),
                showEditBtn: this.getCurrentUserAuthority("/checkrectifydetail/edit")
            }
        },
        mounted() {
            this.getList();
