    ...
    <el-collapse-transition>
      <div class="search-box" v-show="isShowMore">
        <div class="form-box">
          ...
          <div class="form-group">
            <label class="control-label">固定风险级别（1- 一级，2-二级，3-三级，4-四级）</label>
            <div class="input-group">
              <el-input v-model="searchParam.fixedLevel" placeholder="请输入固定风险级别（1- 一级，2-二级，3-三级，4-四级）"></el-input>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label">风险级别（1- 一级，2-二级，3-三级，4-四级）</label>
            <div class="input-group">
              <el-input v-model="searchParam.riskLevel" placeholder="请输入风险级别（1- 一级，2-二级，3-三级，4-四级）"></el-input>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label">预控措施</label>
            <div class="input-group">
              <el-input v-model="searchParam.measure" placeholder="请输入预控措施"></el-input>
            </div>
          </div>
          <div class="form-group">
...
export default {
  ...
  data() {
    return {
      isShowMore: false,
      listUrl: "qsm/safe/risk",
      showSearch: false,
      showAddBtn: this.getCurrentUserAuthority("/safe/risk/add"),
      showEditBtn: this.getCurrentUserAuthority("/safe/risk/edit")
    };
  },
  mounted() {
    this.getList();
