...
<script>
    ...
    export default {
        name: 'SafeCheckRectify',
        mixins: [tool],
        data() {
            return {
                isShowMore:false,
                listUrl: "qsm/safe/checkrectify",
                showSearch: false,
                showAddBtn: this.getCurrentUserAuthority("/safe/checkrectify/save"),
                showEditBtn: this.getCurrentUserAuthority("/safe/checkrectify/edit")
            }
        },
        mounted() {
            this.getList();
